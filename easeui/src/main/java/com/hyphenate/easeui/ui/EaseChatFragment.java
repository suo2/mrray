...
import com.hyphenate.easeui.ui.im.CallReceiver;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location, R.string.attach_video_call, R.string.attach_voice_call};
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.ease_chat_video_call_self, R.drawable.ease_chat_voice_call_self};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION, ITEM_VIDEO, ITEM_VOICE};
    ...
    protected void initView() {
        ...
        this.getActivity().registerReceiver(callReceiver, callFilter);
