...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    private LinearLayout comingBtnContainer;//被呼叫的时候的接听按钮
    ...
    private LinearLayout voiceContronlLayout;//呼叫成功后显示的
    private RelativeLayout callTopWaitContainer;//呼叫成功后显示的
    private TextView mTvVoiceControlName;//被呼叫成功后显示的名字
    private RelativeLayout rootContainer;
    private LinearLayout topContainer;//被呼叫的时候的个人信息
    private TextView netwrokStatusVeiw;
    private TextView mWaitCallName;
    private TextView mWaitCallStatus;
...
//        DemoHelper.getInstance().isVideoCalling = true;
        ...
        mTvVoiceControlName = findViewById(R.id.ll_voice_control_name);
        callTopWaitContainer = findViewById(R.id.call_top_container);
        mWaitCallName = findViewById(R.id.call_top_name);
        mWaitCallStatus = findViewById(R.id.call_top_status);
        topContainer = (LinearLayout) findViewById(R.id.ll_top_container);
        TextView switchCameraBtn = findViewById(R.id.btn_switch_camera);
...
//        recordBtn.setOnClickListener(this);
        ...
        mWaitCallName.setText(username);
        nickTextView.setText(username);
        mTvVoiceControlName.setText(username);
        // local surfaceview
        ...
        if (!isInComingCall) {// outgoing call
            ...
            //等待对方接听
            String st = getResources().getString(R.string.Are_connected_to_each_other);//正在等待对方
            mWaitCallStatus.setText(st);
            callTopWaitContainer.setVisibility(View.VISIBLE);
            ...
            callStateTextView.setText("正在邀请您进行语音通话");
            ...
            callTopWaitContainer.setVisibility(View.GONE);
//            localSurface.setVisibility(View.GONE);
...
//                                EMClient.getInstance().callManager().setSurfaceView(oppositeSurface, localSurface);
                  ...
                  /*          ((TextView) findViewById(R.id.tv_is_p2p)).setText(EMClient.getInstance().callManager().isDirectCall()
                            ...
                            mTvVoiceControlName.setVisibility(View.VISIBLE);
...
//switch camera
        if (i == R.id.local_surface) {
            ...
            if (isMuteState) {
                ...
                changeDrawableTop(muteImage, R.drawable.em_icon_mute_normal);
                try {
                    EMClient.getInstance().callManager().resumeVoiceTransfer();
                } catch (HyphenateException e) {
                    e.printStackTrace();
                ...
                changeDrawableTop(muteImage, R.drawable.em_icon_mute_on);
                try {
                    EMClient.getInstance().callManager().pauseVoiceTransfer();
                } catch (HyphenateException e) {
                    e.printStackTrace();
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
    ...
    private void changeDrawableTop(TextView button, int id) {
