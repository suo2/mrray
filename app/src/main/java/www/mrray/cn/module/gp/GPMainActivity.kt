...
import www.mrray.cn.module.gp.fragment.GpHomeFragment
 ...
 *@desc: GP主界面
 */
class GPMainActivity : BaseActivity() {
    ...
    private lateinit var mGpHomeFragment: GpHomeFragment
    private lateinit var mGpDiscoverFragment: GpDiscoverFragment
    private lateinit var mGpManageFragment: GpManageFragment
    ...
    private fun initFragment() {
        mGpHomeFragment = GpHomeFragment.newInstance()
        mGpDiscoverFragment = GpDiscoverFragment.newInstance()
        mGpManageFragment = GpManageFragment.newInstance()
        mMineFragment = MineFragment.newInstance()
        fragments = arrayOf(mGpHomeFragment, mGpDiscoverFragment, mGpManageFragment, mMineFragment)
        supportFragmentManager
                .beginTransaction()
                .add(R.id.container, mGpHomeFragment)
                .show(mGpHomeFragment)
                .commit()
    }
