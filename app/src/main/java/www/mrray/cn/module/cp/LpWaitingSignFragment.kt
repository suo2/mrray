...
import www.mrray.cn.module.cp.adapter.LpWaitingSignAdapter
import www.mrray.cn.repository.cp.WaitingSignRepository
import www.mrray.cn.viewmodel.cp.WaitingSignViewModel

class LpWaitingSignFragment : BaseViewModelFragment<WaitingSignViewModel, WaitingSignRepository>() {

    val mDataList = ArrayList<Any>()
    val mAdapter = LpWaitingSignAdapter(mDataList)
