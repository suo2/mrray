...
import kotlinx.android.synthetic.main.fragment_home_lp.*
 ...
 *@desc: LP首页
 */
class LpHomeFragment : BaseViewModelFragment<LpHomeViewModel,LpHomeRepository>() {
    private lateinit var mPageRequestBody: PageRequestBody
    private lateinit var projectList: ArrayList<HighProjectModel>
    private lateinit var customerList: ArrayList<FineSelectFundModel>
    ...
    companion object {
        fun newInstance() = LpHomeFragment()
    }
    ...
    private fun initData() {
        ...
        high_customer_more.setOnClickListener { startActivity<FineSelectFundActivity>() }
    ...
    override fun setUpViewModel() {
        ...
        mViewModel.mFineSelectFundModel.observe(this, Observer {
            customerList = (it as PageBaseModel<FineSelectFundModel>).content as ArrayList<FineSelectFundModel>
            mFineSelectFundAdapter = FineSelectFundAdapter(activity!!, customerList)
